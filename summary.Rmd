...
* Linear models for **urine total polyphenol**:
  * There was a significantly **negative** association between urine total polyphenol and the log of dietary total flaonoids (p = 0.0208). There were no significant associations with other dietary polyphenols.
...
* Linear models for **urine total polyphenol / creatinine**:
  * There was a significantly **negative** association between urine total polyphenol/creatinine and the log of dietary total flaonoids (p = 0.0456). There were no significant associations with other dietary polyphenols.
